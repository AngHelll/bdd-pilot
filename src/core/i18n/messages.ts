...
const EN = {
  ...
  "statusBar.hubTooltipTitle": "BDD Pilot — Gherkin cockpit (STAGE · mode · project)",
  ...
  "statusBar.hubTooltipRunFlags": "Run flags: {flags}",
  ...
  "dashboard.subtitle": "Gherkin run history and quality signals for your BDD suite.",
  "dashboard.statRuns": "runs",
  "dashboard.statPassed": "passed (all runs)",
  "dashboard.statFailed": "failed (all runs)",
  "dashboard.recentRuns": "Recent Gherkin runs",
  "dashboard.noRuns": "No Gherkin runs recorded yet.",
  "dashboard.emptyHint":
    "Run scenarios from the <strong>BDD Pilot</strong> Gherkin tree (play on a feature or scenario). History is per workspace — not related to execution profiles.",
  ...
  "dashboard.colAvgDuration": "Avg duration",
  "dashboard.colLastError": "Last error",
  "dashboard.flakyNoError": "—",
  "dashboard.flakyOpenFailed": "Could not open feature file.",
  ...
  "dashboard.runKind.debug": "Debug",
  "dashboard.runKind.profile": "Profile",
  ...
  "dashboard.primaryDiagnosticTitle": "Last run diagnostic",
  ...
  "dashboard.filterStage": "Stage",
  "dashboard.filterOutcome": "Outcome",
  "dashboard.filterRunKind": "Session",
  "dashboard.filterAll": "All",
  "dashboard.filterAnyFailure": "Any failure",
  "dashboard.filterAllPassed": "All passed",
  "dashboard.filterCanceled": "Canceled",
  "dashboard.filterRun": "Run",
  "dashboard.filterReset": "Reset filters",
  "dashboard.filterNoMatches": "No runs match the current filters.",
  "scenarioHistory.title": "Scenario history — {name}",
  "scenarioHistory.empty": "No history for this scenario yet.",
  "scenarioHistory.parentNote": "Showing history for the parent scenario (outline row not recorded separately).",
  "scenarioHistory.openFeature": "Open feature",
  "scenarioHistory.placeholder": "Select a past run",
  "toast.scenarioHistoryNeedLeaf": "Select a scenario or outline row in the BDD Pilot tree.",

  "tree.summaryEmpty": "Run Gherkin scenarios from the Pilot tree to see results.",
  ...
  "tree.summaryRunning": "Running Gherkin…",
  "tree.summaryRehydrate": "Restored (not a new run)",
  "tree.pilotSummaryHint": "Click for Gherkin run history and dashboard",
  "tree.pilotSummaryEditFilter": "Click to edit tree search filter",
  "tree.pilotSummaryCancelHint": "Click to cancel the current Gherkin run",
  "tree.summaryStageChip": "STAGE: {stage}",
  ...
  "log.reviewFirst": "[bdd-pilot] Review first: {buckets}",
  "log.reviewFirstThen": "then",
  "log.hotspot": "[bdd-pilot] Hotspot: {domain} ({count} fails)",
  "toast.reviewFirstHint": "Review first: {bucket} ({count})",
  "toast.noFailureClasses": "No failure classes to filter in the current results.",
  "prompt.filterFailuresByClass": "Filter tree to failure class",
...
const ES: Record<keyof typeof EN, string> = {
  ...
  "statusBar.hubTooltipTitle": "BDD Pilot — cockpit Gherkin (STAGE · modo · proyecto)",
  ...
  "statusBar.hubTooltipRunFlags": "Flags de run: {flags}",
  ...
  "dashboard.subtitle": "Historial de ejecuciones Gherkin y señales de calidad de tu suite BDD.",
  "dashboard.statRuns": "ejecuciones",
  "dashboard.statPassed": "correctos (total)",
  "dashboard.statFailed": "fallidos (total)",
  "dashboard.recentRuns": "Ejecuciones Gherkin recientes",
  "dashboard.noRuns": "Aún no hay ejecuciones Gherkin registradas.",
  "dashboard.emptyHint":
    "Ejecuta escenarios desde el árbol Gherkin <strong>BDD Pilot</strong> (play en feature o escenario). El historial es por workspace — no está ligado a perfiles de ejecución.",
  ...
  "dashboard.colAvgDuration": "Duración media",
  "dashboard.colLastError": "Último error",
  "dashboard.flakyNoError": "—",
  "dashboard.flakyOpenFailed": "No se pudo abrir el archivo .feature.",
  ...
  "dashboard.runKind.debug": "Debug",
  "dashboard.runKind.profile": "Perfil",
  ...
  "dashboard.primaryDiagnosticTitle": "Diagnóstico del último run",
  ...
  "dashboard.filterStage": "Entorno",
  "dashboard.filterOutcome": "Resultado",
  "dashboard.filterRunKind": "Sesión",
  "dashboard.filterAll": "Todos",
  "dashboard.filterAnyFailure": "Con fallos",
  "dashboard.filterAllPassed": "Todos passed",
  "dashboard.filterCanceled": "Canceladas",
  "dashboard.filterRun": "Run",
  "dashboard.filterReset": "Quitar filtros",
  "dashboard.filterNoMatches": "Ninguna ejecución coincide con los filtros.",
  "scenarioHistory.title": "Historial del escenario — {name}",
  "scenarioHistory.empty": "Aún no hay historial para este escenario.",
  "scenarioHistory.parentNote": "Mostrando historial del escenario padre (la fila outline no se registró aparte).",
  "scenarioHistory.openFeature": "Abrir feature",
  "scenarioHistory.placeholder": "Elige una ejecución anterior",
  "toast.scenarioHistoryNeedLeaf": "Selecciona un escenario o fila outline en el árbol BDD Pilot.",

  "tree.summaryEmpty": "Ejecuta escenarios Gherkin desde el árbol Pilot para ver resultados.",
  ...
  "tree.summaryRunning": "Ejecutando Gherkin…",
  "tree.summaryRehydrate": "Restaurado (no es una nueva ejecución)",
  "tree.pilotSummaryHint": "Clic para historial Gherkin y dashboard",
  "tree.pilotSummaryEditFilter": "Clic para editar el filtro del árbol",
  "tree.pilotSummaryCancelHint": "Clic para cancelar la ejecución Gherkin actual",
  "tree.summaryStageChip": "STAGE: {stage}",
  ...
  "bindingGate.issueAmbiguous": "[ambiguo]",
  ...
  "log.reviewFirst": "[bdd-pilot] Revisar primero: {buckets}",
  "log.reviewFirstThen": "luego",
  "log.hotspot": "[bdd-pilot] Hotspot: {domain} ({count} fallos)",
  "toast.reviewFirstHint": "Revisar primero: {bucket} ({count})",
  "toast.noFailureClasses": "No hay clases de fallo para filtrar en los resultados actuales.",
  "prompt.filterFailuresByClass": "Filtrar árbol por clase de fallo",
  "log.runContext": "[bdd-pilot] {stage} · {mode} · {scope} · {time}",
